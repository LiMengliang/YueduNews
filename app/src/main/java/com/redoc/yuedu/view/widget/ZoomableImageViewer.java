...
public class ZoomableImageViewer extends ImageView{
    ...
    public ZoomableImageViewer(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ZoomableImageViewer(Context context) {
        this(context, null);
    }
        ...
        if(getWidth()==0){
            ...
            vto.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener()
            {
                public boolean onPreDraw()
                {
                    initData();
                    //赋值结束后，移除该监听函数
                    ZoomableImageViewer.this.getViewTreeObserver().removeOnPreDrawListener(this);
                    return true;
                }
            });
        }else {
